...
aic_table <- readRDS("data/comparative_table_gp(-2,2,1)_20_k(8,15,20)_bsd2_beta2.rds")
...
This example showcases the varying efficacy of the smoother bases from `mgcv`. We consider an outbreak of scarlet fever in Ontario from 1929 to 1930. The dataset comes from the International Infectious Disease Data Archives (iidda) [@walkerCanmodIiddaInternational2024].
...
# Load the saved R object
aic_table <- readRDS("figure/scarlet_comp.rds")

# Generate and display the table with additional headers
kable(aic_table, format = "latex", booktabs = TRUE, 
      col.names = c("Smooth Type", "k = 5", "k = 8", "k = 10"),
...
# Load the saved R object
aic_table <- readRDS("data/aic_table_Ireland_gp(-3,5)_k(5,6,7)_gamma(014)_I0(10).rds")
